...
# Define RL params
SAVE_PATH = "eval_pid_params"
TENSORBOARD_LOG_NAME = "tensorboard_eval_pid_params"
CPU_CORES = 3
EPISODES = 50_000
ACTIONS_NOISE = 0.1
...
if __name__ == "__main__":
    ...
    # env = make_vec_env(ControllerParamsSim, CPU_CORES, vec_env_cls=SubprocVecEnv, env_kwargs=env_options)
    ...
    ControllerParamsSim(**env_options).eval(model, folder_name=f"{SAVE_PATH}\\{RUN_NBR}")
    # #
