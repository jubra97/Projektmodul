...
if __name__ == "__main__":
    ...
    for pen in [0.1, 0.5, 1, 2, 4, 6, 8, 10]:
        ...
        env = make_vec_env(ControllerParamsSim, 2, vec_env_cls=SubprocVecEnv, env_kwargs={"oscillation_pen_gain": pen, "reward_function": "discrete"})  # create learning env
        ...
        online_eval_env = ControllerParamsSim(log=True, oscillation_pen_gain=pen, reward_function="discrete")  # create eval env
        ...
        ControllerParamsSim(log=True,  oscillation_pen_gain=pen, reward_function="discrete").eval(model, folder_name=RUN_NAME)
        # #
