...
h_map = seaborn.heatmap(df.T, annot=True, linewidths=1.5, cmap="Greens_r", cbar=False)
# h_map.set(xlabel="Actor Bias", ylabel="Given Observation", fontsize=14)
h_map.set_xlabel("Actor Bias", fontsize=14)
h_map.set_ylabel("Given Observation", fontsize=14)
# h_map.set_title("RMSE nach gegebener Observation und Actor Bias", fontsize=16)
h_map.set_yticklabels(labels=h_map.get_yticklabels(), ha="right", linespacing=0.7, fontsize=12)
