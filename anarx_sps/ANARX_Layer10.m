function [x17, state] = ANARX_Layer10(input_1, params, varargin)
%ANARX_LAYER10 Function implementing an imported ONNX network.
%
...
%
% [X17] = ANARX_Layer10(INPUT_1, PARAMS)
%			- Evaluates the imported ONNX network ANARX_LAYER10 with input(s)
%			INPUT_1 and the imported network parameters in PARAMS. Returns
%			network output(s) in X17.
%
% [X17, STATE] = ANARX_Layer10(INPUT_1, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = ANARX_Layer10(INPUT_1, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Function to validate inputs to ANARX_Layer10:
p = inputParser;
