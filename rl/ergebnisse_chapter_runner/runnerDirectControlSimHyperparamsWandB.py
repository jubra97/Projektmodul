...
if __name__ == "__main__":
    ...
    policy_options = {
        ...
        "actor_layer_width": config["actor_width"],  # amount of neurons per layer in the hidden layers
        ...
        "critic_layer_width": config["critic_width"],  # amount of neurons per layer in the hidden layers
