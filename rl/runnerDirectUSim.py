...
if __name__ == "__main__":
    ...
    # env= DirectControllerSim(**env_options)  # only one env; better for debugging
    ...
    model = DDPG(custom_policy.CustomDDPGPolicy,
                 ...
                 train_freq=1,  # change because of multiple parallel envs
                 gradient_steps=1,  # change because of multiple parallel envs
