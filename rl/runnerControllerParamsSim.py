...
from rl.envs.ControllerParamsSim import ControllerParamsSim
...
env_options = {
    ...
    "p_range": 0.1,  # set p max and corresponding scaling (action:-1 --> 0; action:1 --> p_range)
    "i_range": 100,  # set i max and corresponding scaling (action:-1 --> 0; action:1 --> i_range)
...
if __name__ == "__main__":
    ...
    # env= ControllerParamsSim(**env_options) # only one env; better for debugging
